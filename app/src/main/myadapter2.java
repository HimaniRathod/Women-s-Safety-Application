...
public class myadapter2 extends FirebaseRecyclerAdapter<Model,myadapter2.myviewholder> {
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, final int position, @NonNull Model model) {
        ...
        holder.img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(holder.t2.getContext(), "" + model.getDesc().toString(), Toast.LENGTH_SHORT).show();
                Intent intent  = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:"+model.getDesc().toString()));
    ...
    public class myviewholder extends RecyclerView.ViewHolder
    {
        ...
        public myviewholder(@NonNull View itemView)
        {
            ...
            img=(ImageView)itemView.findViewById(R.id.btncall);
        }
    }
}
